...
echo "  4. Ensure omlx VLM server is running at http://localhost:8000 (used by history/segmentation/IME):"
echo "     curl -s -H "Authorization: Bearer omlxkey" http://localhost:8000/v1/models"
echo "  5. Run tests:"
